...
export default function Merit() {
  ...
  return (
    <Box className="merit  laptop:pt-[14vh] pt-[10vh] section">
        ...
        <Container className="flex flex-wrap">
          {lists.map((list) => (
            <Box className="laptop:w-1/3 laptop:px-vw-10 w-full mb-0 mx-auto">
              <Box className="text-center laptop:w-3/4 w-[150px] mx-auto laptop:min-h-[30vh]">
                <Image src={list.img} objectFit={"cover"} />
              </Box>
              <Typography className="text-primary text-md text-center whitespace-nowrap font-bold laptop:my-vw-6 my-2">
                {list.dt}
              </Typography>
