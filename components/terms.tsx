export default function Terms() {
  return (
    <div className="wrap">
      <h1 className="text-lg my-8">利用規約</h1>
      <p className="text-sm font-light leading-5 my-6">
        この利用規約（以下，「本規約」といいます。）は、ANful（以下、「当社」といいます）（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </p>

      <h2 className="text-md my-4">第1条（適用）</h2>
      <ol className="list-decimal pl-10">
        <li className="text-sm font-light leading-5 my-6">
      ...
      <h2 className="text-md my-4">第2条（利用登録）</h2>
      <ol className="list-decimal pl-10">
        <li className="text-sm font-light leading-5 my-6">
      ...
      <h2 className="text-md my-4">第4条（利用料金および支払方法）</h2>
      <ol className="list-decimal pl-10">
        <li className="text-sm font-light leading-5 my-6">
      ...
      <h2 className="text-md my-4">第5条（禁止事項）</h2>
      <p className="text-sm font-light leading-5 my-6">
      ...
      <h2 className="text-md my-4">第6条（本サービスの提供の停止等）</h2>
      <ol className="list-decimal pl-10">
        <li className="text-sm font-light leading-5 my-6">
      ...
      <h2 className="text-md my-4">第7条（著作権）</h2>
      <ol className="list-decimal pl-10">
        <li className="text-sm font-light leading-5 my-6">
      ...
      <h2 className="text-md my-4">第8条（利用制限および登録抹消）</h2>
      <ol className="list-decimal pl-10">
        <li className="text-sm font-light leading-5 my-6">
      ...
      <h2 className="text-md my-4">第9条（退会）</h2>
      <p className="text-sm font-light leading-5 my-6">
        ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。
      </p>

      <h2 className="text-md my-4">第10条（保証の否認および免責事項）</h2>
      <ol className="list-decimal pl-10">
        <li className="text-sm font-light leading-5 my-6">
      ...
      <h2 className="text-md my-4">第11条（サービス内容の変更等）</h2>
      <p className="text-sm font-light leading-5 my-6">
        当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
      </p>

      <h2 className="text-md my-4">第12条（利用規約の変更）</h2>
      <ol className="list-decimal pl-10">
        <li className="text-sm font-light leading-5 my-6">
      ...
      <h2 className="text-md my-4">第13条（個人情報の取扱い）</h2>
      <p className="text-sm font-light leading-5 my-6">
        当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
      </p>

      <h2 className="text-md my-4">第14条（通知または連絡）</h2>
      <p className="text-sm font-light leading-5 my-6">
        ユーザーと当社との間の通知または連絡は，当社の定める方法によって行うものとします。当社は,ユーザーから,当社が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。
      </p>

      <h2 className="text-md my-4">第15条（権利義務の譲渡の禁止）</h2>
      <p className="text-sm font-light leading-5 my-6">
        ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
      </p>

      <h2 className="text-md my-4">第16条（準拠法・裁判管轄）</h2>
      <ol className="list-decimal pl-10">
        <li className="text-sm font-light leading-5 my-6">
